...
**PS: 现在 deepwiki mcp server 似乎也要科学上网才能调用了, 例如**  
```
all_proxy=socks5h://127.0.0.1:11112 http_proxy=http://127.0.0.1:22222 https_proxy=http://127.0.0.1:22222 qwen


# 如果是 claude
claude mcp add --transport http -s user deepwiki https://mcp.deepwiki.com/mcp
HTTP_PROXY=http://127.0.0.1:22222 HTTPS_PROXY=http://127.0.0.1:22222 ALL_PROXY=http://127.0.0.1:22222 NO_PROXY=127.0.0.1,localhost,host.docernal claude
```
